test_that("tutorial and beamer templates are present in inst", {
  ...
  tutorial_pdf_dir <- test_path("..", "..", "inst", "rmarkdown", "templates", "biostatlab_tutorial_pdf")
  ...
  expect_true(dir.exists(tutorial_pdf_dir))
  expect_true(file.exists(file.path(tutorial_pdf_dir, "template.yaml")))
  expect_true(file.exists(file.path(tutorial_pdf_dir, "skeleton", "skeleton.Rmd")))
  expect_true(file.exists(file.path(tutorial_pdf_dir, "skeleton", "biostatlab-tutorial-pdf.tex")))
